...
export default function PrivacyPolicy() {
  return (
    <>
      <Navbar />
      <div className="text-primaryColor p-8 rounded-lg shadow-md">
        <h1 className="text-4xl font-bold mb-4">Privacy Policy Year2Year</h1>
        <p className="mb-4"><strong className="font-semibold">Effective Date:</strong> April 10, 2024</p>
        <p className="mb-4">Welcome to Year2Year! We value your privacy and are committed to protecting your personal information.</p>
        ...
        <p className="mb-4">However, please note that no method of transmission over the internet or electronic storage is completely secure.</p>
        <h2 className="text-2xl font-bold mt-8 mb-2">4. Third-Party Services:</h2>
        <p className="mb-4">Year2Year does not have any third party services.</p>
        <h2 className="text-2xl font-bold mt-8 mb-2">5. Your Rights:</h2>
        <p className="mb-4">You have the right to access, update, or delete your personal information. If you have any concerns, please contact our support team.</p>
        <h2 className="text-2xl font-bold mt-8 mb-2">6. Changes to this Policy:</h2>
        <p className="mb-4">We may update this Privacy Policy periodically. Check our website for the latest version. By using Year2Year, you agree to the terms outlined in this Privacy Policy.</p>
        <p className="mb-4">If you have any questions or need assistance, feel free to reach out to us at year2yearmcrsupport@gmail.com.</p>
        <p className="mb-4">Thank you for choosing Year2Year for your tutoring needs! 📚🎓</p>
      </div>
